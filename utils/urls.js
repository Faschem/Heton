const globalUrls = {
  ...
  lvList:"https://m.douban.com/rexxar/api/v2/subject_collection/tv_hot/items",
  ...
  searchFor:function(p){
    return "https://m.douban.com/rexxar/api/v2/search?type=movie&q=" + p;
  }
